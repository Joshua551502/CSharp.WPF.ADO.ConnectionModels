...
namespace CSharp.WPF.ADO.ConnectionModels.NorthwindDataSetTableAdapters {
    ...
    public partial class CategoriesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [Categories] SET [CategoryName] = @CategoryName WHERE (([CategoryID] = @Or" +
                "iginal_CategoryID) AND ([CategoryName] = @Original_CategoryName));\r\nSELECT Categ" +
                "oryID, CategoryName FROM Categories WHERE (CategoryID = @CategoryID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::CSharp.WPF.ADO.ConnectionModels.Properties.Settings.Default.NorthwindConnectionString;
        }
        ...
        public virtual int FillCategoryName(NorthwindDataSet.CategoriesDataTable dataTable, string CategoryName) {
        ...
        public virtual NorthwindDataSet.CategoriesDataTable GetCategoryByName(string CategoryName) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            if ((CategoryName == null)) {
                throw new global::System.ArgumentNullException("CategoryName");
            }
